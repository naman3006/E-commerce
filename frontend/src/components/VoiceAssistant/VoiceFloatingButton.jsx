...
const VoiceFloatingButton = () => {
    ...
    return (
        ...
        >
            {isListening ? (
                // Pulsing Wave Icon or Stop Icon
                <svg className="w-8 h-8 animate-bounce-short" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Ripple Effect Ring (Optional Visual) */}
            {!isListening && (
